...
public class Recommend extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (BMI >= 25) { // 유산소 운동 부분
            ...
            set.setOnClickListener(view -> Toast.makeText(Recommend.this, "수정없이 바로 시작하세요", Toast.LENGTH_LONG).show());
            ...
            info.setOnClickListener(view -> {
                AlertDialog.Builder program_info = new AlertDialog.Builder(this);
                program_info.setIcon(R.mipmap.ic_launcher);
                program_info.setTitle("유산소운동 상세정보");
                program_info.setMessage(getString(R.string.running));
                program_info.setPositiveButton("닫기", new DialogInterface.OnClickListener() {
                    @Override
            ...
            set.setOnClickListener(view -> {
                ...
                FixButton.setOnClickListener(view19 -> {
